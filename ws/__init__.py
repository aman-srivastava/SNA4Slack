...
class Utils:
    ...
    def get_Connection_Productivity():
        ...
        connection.setup(['35.192.53.69'], "atlas_productivity", protocol_version=3, auth_provider=ap)
    pass
    ...
    def get_Connection_Journal():
        ...
        cluster = Cluster(node_ips, auth_provider=ap)
        session = cluster.connect()
        connection.setup(['35.192.53.69'], "atlas_journal", protocol_version=3, auth_provider=ap)
    pass
